...
export default function PackagingsList({ onItemDrag, isExpanded }) {
  ...
  // Pobierz opakowania i ostatnią synchronizację przy montowaniu
  useEffect(() => {
    fetchPackagings()
  ...
  return (
    <div className="mb-8 bg-white rounded-lg shadow-md overflow-hidden">
      <div
        ...
        onClick={() => onItemDrag('toggle')} // Możesz przekazać np. toggle z zewnątrz
      >
      ...
      {isExpanded && (
        <div className="p-4">
          {isLoading ? (
            ...
            <Droppable droppableId="packagings-list" type="calendar-day" isDropDisabled={true}>
              {(provided) => (
                <div
